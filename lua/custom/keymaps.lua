...
-- Motions
vim.keymap.set('n', '<leader><leader>', ':HopWord<Enter>', { desc = 'Jump to any word' })
vim.keymap.set('n', '<leader>jl', ':HopLineStart<Enter>', { desc = 'Jump to line start' })
vim.keymap.set('n', '<leader>jk', ':HopChar2<Enter>', { desc = 'Jump to two matching chars' })
